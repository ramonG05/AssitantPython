...
class AsistenteGUI(QMainWindow):
    def __init__(self):
        ...
        # Variable para almacenar el estado del teclado
        self.teclado_activo = True
        
        try:
            # Configurar el detector de tecla F1 global
            keyboard.add_hotkey('f1', self.iniciar_escucha)
        except Exception as e:
    ...
    def initUI(self):
        ...
        # Título
        title_label = QLabel('Asistente de Voz - Tecla F1')
